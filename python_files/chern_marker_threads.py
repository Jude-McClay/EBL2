...
if __name__ == "__main__":
    ...
    print("hi, I'm the threading program, wish me luck :)")
    ...
    thread_list = []
    for m in MASS_LIST:
        t = ReturnableThread(target = lcm_calc, args=(m, W_LIST, NX, NY))
        t.start()
        thread_list.append(t)

    # store the results in a lcm list
    for i, t in enumerate(thread_list):
        chern_dictinoary_array[i] = t.join()
